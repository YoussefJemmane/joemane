...
export default function Home() {
  ...
  useEffect(() => {
    setLoading(true)
    fetch('https://api.github.com/users/YoussefJemmane/repos')
      .then((res) => res.json())
      .then((repo) => {
        setRepo(repo)
        setLoading(false)
  ...
  if (!repo) return <p>No profile {data.name}</p>
  return (
    <HydrationProvider>
      <Client>
        <div className='p-1' >
            ...
            <div className='flex justify-center m-5' >
              <div className="card w-96 bg-base-100 shadow-xl" data-theme='light'>
                ...
                <div className="card-body ">
                  <h2 className="card-title">My name is {data.name} <br /> I'm Full Stack Developer</h2>

                  <div className="card-actions justify-center pt-5">
                    <a href="./Youssef_Jemmane.pdf" className='btn btn-primary' download>This is My CV</a>
                  </div>
                </div>
              </div>
            </div>
                          ...
                          <>
                            {
                              repo.size === 0 ? null :
                                <div className="flex items-center rounded-lg shadow-sm  " data-theme='synthwave'>
                                  <div className="card-body">
                                    <h2 className="card-title">{repo.name} &rarr; {repo.language}</h2>
                                    <div>
                                      <a href={repo.html_url} className='btn btn-secondary mr-5 mb-5'>GitHub</a>
                                      {/* if homepage ==null don't show demo */}
                                      {repo.homepage ? <a href={repo.homepage} className='btn btn-primary'>Demo</a> : null}
                                    </div>
                                  </div>
                                </div>
                            }
