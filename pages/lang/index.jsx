            ...
            <div className='flex justify-center m-5' >
              <div className="card w-96 bg-base-100 shadow-xl" data-theme='light'>
                ...
                <div className="card-body ">
                  ...
                  <p>Je suis étudiant en développement Full Stack à l'OFPPT au Maroc.</p>
              ...
              <div className='grid gap-6 mb-8 md:grid-cols-1 lg:grid-cols-1'>
                <div className="flex items-center p-4  rounded-lg shadow-sm  " data-theme='light'>
                  <div className="card-body">
                    ...
                    <p className=' '>
                      En tant qu'étudiant en développement full stack à OFPPT, j'ai développé une solide connaissance des technologies front-end et back-end, notamment <strong>React</strong>, <strong>Redux</strong>, <strong>Redux Toolkit</strong>, <strong>développement d'API</strong>, <strong>Laravel</strong>, <strong>PHP</strong> et <strong>MySQL</strong>. Je suis habile à construire des applications web modernes et dynamiques qui offrent aux utilisateurs une expérience fluide et intuitive.

                      Je suis passionné par l'utilisation de mes compétences et de mes connaissances pour créer des solutions innovantes qui résolvent les problèmes du monde réel et je suis toujours à la recherche de nouveaux défis et de possibilités d'apprentissage en tant que développeur. Dans l'avenir, j'espère continuer à apprendre et à améliorer mes compétences et à utiliser finalement mon expertise pour avoir un impact positif sur le monde grâce à la technologie.
                    </p>
              ...
              <div className='grid gap-6 mb-8 md:grid-cols-1 lg:grid-cols-2'>
                <div className="flex items-center p-4  rounded-lg shadow-sm  " data-theme='light'>
                  <div className="card-body">
                    ...
                    <p>Je suis habile à créer des sites web CRUD en utilisant PHP, MySQL, Laravel, React et Redux. Je suis capable de combiner mes connaissances en technologies front-end et back-end pour créer des applications web bien équilibrées et conviviales pour l'utilisateur. Je suis passionné par l'utilisation de la technologie pour résoudre les problèmes du monde réel et je suis toujours à la recherche de nouvelles opportunités pour apprendre et grandir en tant que développeur.</p>
                  </div>
                </div>
                <div className="flex  items-center p-4 rounded-lg shadow-sm  " data-theme='light'>
                  <div className="card-body">
                    <h2 className="card-title">Hobbies &rarr;</h2>
                    <p>Je suis passionné par la résolution de ciphers, le basket-ball et les jeux vidéo. Ces intérêts m'ont aidé à développer une grande gamme de compétences précieuses, notamment la résolution de problèmes, la coordination, le travail d'équipe, la pensée stratégique et l'analyse critique. Mon jeu préféré, The Legend of Zelda, m'a particulièrement inspiré pour développer ma créativité et mes compétences en matière de résolution de problèmes.</p>
                  </div>
                </div>
              </div>
